import{_ as s,o as a,c as e,ag as p}from"./chunks/framework.CvgP6Fyv.js";const g=JSON.parse('{"title":"Conditional Rendering","description":"","frontmatter":{},"headers":[],"relativePath":"docs/examples/conditional.md","filePath":"docs/examples/conditional.md","lastUpdated":1772091229000}'),i={name:"docs/examples/conditional.md"};function o(l,n,t,r,c,d){return a(),e("div",null,[...n[0]||(n[0]=[p(`<h1 id="conditional-rendering" tabindex="-1">Conditional Rendering <a class="header-anchor" href="#conditional-rendering" aria-label="Permalink to &quot;Conditional Rendering&quot;">​</a></h1><p>Demonstrates using <code>if</code> blocks to conditionally show/hide elements.</p><h2 id="source-code" tabindex="-1">Source Code <a class="header-anchor" href="#source-code" aria-label="Permalink to &quot;Source Code&quot;">​</a></h2><div class="language-hjx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">hjx</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>component UserProfile</span></span>
...
<span class="line"><span>    set isPremium = true</span></span></code></pre></div><h2 id="key-concepts" tabindex="-1">Key Concepts <a class="header-anchor" href="#key-concepts" aria-label="Permalink to &quot;Key Concepts&quot;">​</a></h2><ul><li><strong>Conditional blocks</strong>: <code>if (condition):</code> shows content when true</li><li><strong>Negation</strong>: <code>!isLoggedIn</code> checks if NOT logged in</li><li><strong>State changes</strong>: Handlers toggle boolean values</li></ul><h2 id="how-it-works" tabindex="-1">How It Works <a class="header-anchor" href="#how-it-works" aria-label="Permalink to &quot;How It Works&quot;">​</a></h2><ol><li>The <code>if</code> block checks the condition</li><li>If true, the content is rendered</li><li>If false, the content is hidden (display: none)</li><li>When state changes, conditions are re-evaluated</li><li>UI updates to show/hide appropriate content</li></ol><h2 id="running" tabindex="-1">Running <a class="header-anchor" href="#running" aria-label="Permalink to &quot;Running&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">node</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> dist/cli.js</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> dev</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> examples/conditional.hjx</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --out</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> dist-app</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --port</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 5172</span></span></code></pre></div><p>Try clicking:</p><ul><li>&quot;Logout&quot; - shows login prompt</li><li>&quot;Login&quot; - shows dashboard</li><li>&quot;Upgrade Now&quot; - shows premium badge</li></ul>`,12)])])}const h=s(i,[["render",o]]);export{g as __pageData,h as default};
