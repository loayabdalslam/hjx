...
<span class="line"><span>  </span></span>
<span class="line"><span>  decrement:</span></span>
<span class="line"><span>    set count = count - 1</span></span></code></pre></div><h2 id="computed-values" tabindex="-1">Computed Values <a class="header-anchor" href="#computed-values" aria-label="Permalink to &quot;Computed Values&quot;">​</a></h2><p>While HJX doesn&#39;t have computed properties, you can compute values in handlers:</p><div class="language-hjx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">hjx</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>state:</span></span>
...
<span class="line"><span>    set sum = a + b</span></span></code></pre></div><h2 id="state-with-arrays" tabindex="-1">State with Arrays <a class="header-anchor" href="#state-with-arrays" aria-label="Permalink to &quot;State with Arrays&quot;">​</a></h2><div class="language-hjx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">hjx</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>state:</span></span>
...
<span class="line"><span>    view.item: &quot;{{item}}&quot;</span></span></code></pre></div>`,31)])])}const g=s(p,[["render",i]]);export{r as __pageData,g as default};
